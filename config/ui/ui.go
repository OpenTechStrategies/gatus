...
func (cfg *Config) ValidateAndSetDefaults() error {
	...
	if cfg.RecentChecksMaximumRows <= 0 {
		cfg.RecentChecksMaximumRows = 2
	}
	if cfg.RecentChecksResultsPerRow <= 0 {
		cfg.RecentChecksResultsPerRow = 50
	}
	if len(cfg.RecentChecksResultHeight) == 0 {
		cfg.RecentChecksResultHeight = "1.5rem"
	}
